...
int main(int argc, char** argv) {
    ...
    if (demoFurnace) {
        app.survival = true;
        app.player.flying = true;
        // Place a furnace 3 blocks in front of the player (horizontal look
        ...
        // Bump up one level if the chosen cell is inside terrain.
        ...
        // Active burn so the flame indicator is on and cookTicks advance.
